...
<body id="page-top" class="temadark-<?= $temaDark ?>">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion toggled" id="accordionSidebar">
      ...
      <!-- Nav Item - Projetos -->
      <li class="nav-item <?php if ($viewName == 'turmas' || $viewName == 'turma' || $viewName == 'entregaProjetos') : echo 'active';
                          endif; ?>">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- Nav Item - Convites -->
            <li class="stop-ajax nav-item dropdown no-arrow mx-1" id="convitesProfessor" data-url="<?= HOME ?>"></li>

            <!-- Nav Item - Notificações -->
            <li class="stop-ajax nav-item dropdown no-arrow mx-1 notificacoes-green" id="notificacoes" data-url="<?= HOME ?>"></li>
