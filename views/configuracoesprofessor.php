                    ...
                    <form>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" name="perfil-escola" id="perfil-escola" data-error="Selecione uma opção..." required>
                                    <option <?php if ($escola == 'Exatas') {
                                                echo 'selected';
                                            } ?>>Exatas</option>
                                    <option <?php if ($escola == 'Humanas') {
                                                echo 'selected';
                                            } ?>>Humanas</option>
                                    <option <?php if ($escola == 'Biológicas') {
                                                echo 'selected';
                                            } ?>>Biológicas</option>
                                </select>
                            </div>
