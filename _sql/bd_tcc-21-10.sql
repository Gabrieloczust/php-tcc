...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Out-2019 às 22:57
...
--
ALTER TABLE `aluno`
  MODIFY `ra` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Registro do Aluno', AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT de tabela `convite`
--
ALTER TABLE `convite`
  MODIFY `idConvite` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;

--
-- AUTO_INCREMENT de tabela `professor`
--
ALTER TABLE `professor`
  MODIFY `rp` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Registro do Professor', AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de tabela `projeto`
--
ALTER TABLE `projeto`
  MODIFY `idProjeto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT de tabela `projeto_tem_aluno`
--
ALTER TABLE `projeto_tem_aluno`
  MODIFY `idAlunoProjeto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
...
--
ALTER TABLE `convite`
  ADD CONSTRAINT `fkProjeto` FOREIGN KEY (`fkProjeto`) REFERENCES `projeto` (`idProjeto`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `projeto_tem_aluno`
--
ALTER TABLE `projeto_tem_aluno`
  ADD CONSTRAINT `fk_Aluno_has_Projeto_Aluno` FOREIGN KEY (`fkAluno`) REFERENCES `aluno` (`ra`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Aluno_has_Projeto_Projeto1` FOREIGN KEY (`fkProjeto`) REFERENCES `projeto` (`idProjeto`) ON DELETE CASCADE ON UPDATE NO ACTION;
